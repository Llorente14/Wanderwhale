...
class _AiChatState extends State<AiChat> with SingleTickerProviderStateMixin {
  ...
  Future<void> _sendMessage(String text) async {
    ...
    try {
      ...
      setState(() {
        _isLoading = false;
        _addBotMessage("I apologize, but I'm having trouble connecting right now. "
      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          'messages': [
            {
              'role': 'system',
              'content': 'You are a helpful and friendly travel assistant. Provide helpful travel advice, tips, and recommendations. Be concise and engaging.',
            },
            {
              'role': 'user',
              'content': userMessage,
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            mainAxisSize: MainAxisSize.min,
            children: [
              _buildTipItem('📅', 'Book flights 2-3 months in advance for best prices'),
              ...
              _buildTipItem('🛡️', 'Get travel insurance for international trips'),
