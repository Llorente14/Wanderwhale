...
import 'flight_data.dart'; // Keep for types if needed, but data comes from provider
...
class _FlightRecommendationScreenState
                ...
                optionsViewBuilder: (context, onSelected, options) {
                  return Align(
                    ...
                    child: Material(
                      elevation: 4.0,
                      child: SizedBox(
                        width: MediaQuery.of(context).size.width - 32, // Match container width
  ...
  Widget _buildJustForYouSection(List<FlightOfferModel> cards, List<String> destinations) {
    return Padding(
      padding: const EdgeInsets.all(16.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
